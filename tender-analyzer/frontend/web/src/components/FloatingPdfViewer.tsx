...
const FloatingPdfViewer = () => {
  const { isVisible, activeReference, tenderId, hide, toggle, clearActiveReference } = usePdfViewerStore()
  ...
  return (
    <>
      ...
      {isVisible &&
        createPortal(
          <div className="floating-pdf-viewer" role="dialog" aria-modal="true" aria-label="Document preview">
            <div className="floating-pdf-viewer__header">
              <div>
                <p className="floating-pdf-viewer__title">PDF preview</p>
                <p className="floating-pdf-viewer__subtitle">Inspect highlighted references in context.</p>
              </div>
              <button
                type="button"
            ...
            <div className="floating-pdf-viewer__body">
              <PdfPreviewWithHighlights
                ...
                onClearReference={clearActiveReference}
              />
            </div>
          </div>,
          document.body,
